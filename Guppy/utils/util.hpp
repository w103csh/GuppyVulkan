...
#define APP_NAME_STR_LEN 80
    ...
    VkDebugUtilsMessengerEXT callback;  // validation layer callback
};
...
void set_image_layout(struct sample_info &demo, VkCommandBuffer &cmd, VkImage image, VkImageAspectFlags aspectMask,
