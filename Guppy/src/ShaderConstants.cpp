...
const std::map<SHADER, Shader::CreateInfo> ALL = {
    ...
    {SHADER::FOUNTAIN_PART_VERT, Shader::Particle::FOUNTAIN_PART_VERT_CREATE_INFO},
    {SHADER::FOUNTAIN_PART_DEFERRED_MRT_FRAG, Shader::Particle::FOUNTAIN_PART_FRAG_DEFERRED_MRT_CREATE_INFO},
    {SHADER::PARTICLE_EULER_COMP, Shader::Particle::PARTICLE_EULER_CREATE_INFO},
    {SHADER::FOUNTAIN_PART_EULER_VERT, Shader::Particle::FOUNTAIN_PART_EULER_VERT_CREATE_INFO},
    {SHADER::SHADOW_FOUNTAIN_PART_EULER_VERT, Shader::Particle::SHADOW_FOUNTAIN_PART_EULER_VERT_CREATE_INFO},
};
