...
class Handler : public Game::Handler {
   ...
   public:
    ...
    inline Manager<Light::Shadow::Positional>& lgtShdwPosMgr() { return std::get<Uniform::Manager<Light::Shadow::Positional>>(managers_[5]);};
    inline Manager<Default::Fog::Base>& uniDefFogMgr() { return std::get<Uniform::Manager<Default::Fog::Base>>(managers_[6]);};
    inline Manager<Default::Projector::Base>& uniDefPrjMgr() { return std::get<Uniform::Manager<Default::Projector::Base>>(managers_[7]);};
    inline Manager<ScreenSpace::Default>& uniScrDefMgr() { return std::get<Uniform::Manager<ScreenSpace::Default>>(managers_[8]);};
    inline Manager<Deferred::SSAO>& uniDfrSSAOMgr() { return std::get<Uniform::Manager<Deferred::SSAO>>(managers_[9]);};
    inline Manager<Shadow::Base>& uniShdwDataMgr() { return std::get<Uniform::Manager<Shadow::Base>>(managers_[10]);};
    inline Manager<Tessellation::Default::Base>& uniTessDefMgr() { return std::get<Uniform::Manager<Tessellation::Default::Base>>(managers_[11]);};
    inline Manager<Geometry::Default::Base>& uniGeomDefMgr() { return std::get<Uniform::Manager<Geometry::Default::Base>>(managers_[12]);};
    inline Manager<Particle::Wave::Base>& uniWaveMgr() { return std::get<Uniform::Manager<Particle::Wave::Base>>(managers_[13]);};
    inline Manager<Storage::PostProcess::Base>& strPstPrcMgr() { return std::get<Uniform::Manager<Storage::PostProcess::Base>>(managers_[14]);};
   ...
   private:
    ...
    using Manager = std::variant<                     //
        ...
        >;
    std::array<Manager, 15> managers_;
