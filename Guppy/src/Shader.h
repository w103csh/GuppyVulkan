...
//};
//
// class UtilityVertex : public Shader::Link::Base {
//   public:
//    UtilityVertex(Shader::Handler &handler);
//};
//
// class UtilityFragment : public Shader::Link::Base {
//   public:
//    UtilityFragment(Shader::Handler &handler);
//};
//
// class BlinnPhong : public Shader::Link::Base {
//   public:
//    BlinnPhong(Shader::Handler &handler);
//};
//
// namespace Default {
